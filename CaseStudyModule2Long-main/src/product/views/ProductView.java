        ...
        try {
            ...
            switch (options) {
                case -1:
                    break;
                case 1:
                    product.setType(PType.RIFLE);
                    break;
                case 2:
                    product.setType(PType.PISTOL);
                    break;
                case 3:
                    product.setType(PType.SABER);
                    break;
                case 4:
                    product.setType(PType.TANK);
                    break;
                case 5:
                    product.setType(PType.AIRPLANE);
                    break;
                default:
                    System.out.println("Nhập không đúng! Vui lòng nhập lại");
                    setPType(product);
